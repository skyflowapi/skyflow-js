...
*/
// flowvault HTTP client (transport). Package-owned per the loose-coupling
// decision — structurally identical to skyflow-js's, but wired to @core (neutral
// SkyflowError base, constants, logs, types) and flowvault's own telemetry
// helpers. flowDB API errors are shaped by the data layer (SkyflowFlowDBError);
// this client only raises the neutral transport-level SkyflowError.
