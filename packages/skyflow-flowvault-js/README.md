# skyflow-flowvault-js
Skyflow's Flow vault JavaScript SDK lets you securely collect, tokenize, and reveal sensitive data in the browser without exposing your front-end infrastructure to sensitive data.
...
[![npm](https://img.shields.io/npm/v/skyflow-flowvault-js.svg)](https://www.npmjs.com/package/skyflow-flowvault-js)
...
```html
<script src="https://js.skyflow.com/flowvault/v1/index.js"></script>
```
...
```
npm install skyflow-flowvault-js
```
...
```javascript
import Skyflow from 'skyflow-flowvault-js' // If using script tag, this line is not required.
...
`Note`:
  ...
  - Use `env` option with caution, make sure the env is set to `PROD` when using `skyflow-flowvault-js` in production. 
...
```javascript
import Skyflow from 'skyflow-flowvault-js';
...
**[Sample Code:](https://github.com/skyflowapi/skyflow-js/blob/main/packages/skyflow-flowvault-js/samples/using-script-tag/skyflow-elements.html)**
...
- [Card brand choice](https://github.com/skyflowapi/skyflow-js/blob/main/packages/skyflow-flowvault-js/samples/using-script-tag/card-brand-choice.html):
...
The Sample [code snippet](https://github.com/skyflowapi/skyflow-js/blob/main/packages/skyflow-flowvault-js/samples/using-script-tag/custom-validations.html) for using custom validations:
...
##### Sample [code snippet](https://github.com/skyflowapi/skyflow-js/blob/main/packages/skyflow-flowvault-js/samples/using-script-tag/collect-element-listeners.html) for using listeners 
```javascript
