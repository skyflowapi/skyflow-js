...
export const ELEMENT_EVENTS_TO_IFRAME = {
  RENDER: 'RENDER',
  ZIP_RENDER_MOUNTED: 'ZIP_RENDER_MOUNTED',
  ZIP_RENDER_URL: 'ZIP_RENDER_URL',
  ZIP_RENDER_URL_RESPONSE: 'ZIP_RENDER_URL_RESPONSE',
  ZIP_RENDER_MOUNT: 'ZIP_RENDER_MOUNT',
  ZIP_FILES_ELEMENTS_ID: 'ZIP_FILES_ELEMENTS_ID',
  ...
  ZIP_FILES_RESPONSE: 'ZIP_FILES_RESPONSE',
};
