...
export const ELEMENT_EVENTS_TO_IFRAME = {
  REVEAL_CALL_WINDOW_CLIENT_RESPONSES: 'REVEAL_CALL_WINDOW_CLIENT_RESPONSES',
  RENDER_CALL_WINDOW_CLIENT_RESPONSES: 'REVEAL_CALL_WINDOW_CLIENT_RESPONSES',
  REVEAL_CALL_WINDOW_RESPONSE: 'REVEAL_CALL_WINDOW_RESPONSE',
  RENDER_CALL_WINDOW_RESPONSE: 'RENDER_CALL_WINDOW_RESPONSE',
  RENDER_CALL_WINDOW_REQUEST: 'RENDER_CALL_WINDOW_REQUEST',
  REVEAL_CALL_WINDOW_REQUEST: 'REVEAL_CALL_WINDOW_REQUEST',
  SKYFLOW_CONTROLLER_READY: 'SKYFLOW_CONTROLLER_READY',
  COLLECT_CALL_REQUESTS: 'COLLECT_CALL_REQUESTS',
  COLLECT_CALL_REQUEST: 'COLLECT_CALL_REQUEST',
  COLLECT: 'COLLECT',
  COLLECT_SUCCESS: 'COLLECT_SUCCESS',
  COLLECT_FILE_SUCCESS: 'COLLECT_FILE_SUCCESS',
  RENDER_CALL_REQUESTS: 'REVEAL_CALL_REQUESTS',
  ...
  GET_ACCESS_TOKEN_BACK: 'GET_ACCESS_TOKEN_BACK',
