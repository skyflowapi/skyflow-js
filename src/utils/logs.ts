const logs = {
  ...
  errorLogs: {
    ...
    INVALID_SOAP_REQUEST_XML: 'Interface: invokeSoapConnection - Invalid requestXML',
    INVALID_SOAP_RESPONSE_XML: 'Interface: invokeSoapConnection - Invalid responseXML',
