...
const logs = {
  ...
  errorLogs: {
    ...
    MISSING_TABLE_IN_ADDITIONAL_FIELDS: 'Validation error. \'tableName\' key not found in additionalFields record at index %s1',
    INVALID_TABLE_IN_ADDITIONAL_FIELDS: 'Validation error.Invalid tableName key value in additionalFields record at index %s1. Specify a value of type string for tableName key.',
    INVALID_SKYFLOW_ID_IN_ADDITIONAL_FIELDS: 'Validation error.Invalid \'skyflowId\' key value in additionalFields record at index %s1. Specify a valid value for \'skyflowId\' key.',
    MISSING_FIELDS_IN_ADDITIONAL_FIELDS: 'Validation error.\'data\' key not found in additionalFields record at index %s1. Specify a \'data\' key in additionalFields record at index %s1.',
    INVALID_FIELDS_IN_ADDITIONAL_FIELDS: 'Validation error.invalid \'data\' key value in additionalFields record at index %s1. Specify a value of type object for \'data\' key.',
    ...
    INVALID_TOKEN_GROUP_REDACTIONS_REVEAL: 'Validation error. Invalid \'tokenGroupRedactions\' key in reveal options. Specify an array of { tokenGroupName, redaction } objects.',
    INVALID_TOKEN_GROUP_REDACTION_ENTRY_REVEAL: 'Validation error. Invalid \'tokenGroupRedactions\' entry at index %s1. Specify a non-empty string \'tokenGroupName\' and \'redaction\'.',
    ELEMENTS_NOT_MOUNTED_REVEAL: 'Reveal failed. Make sure to mount all elements before invoking \'reveal\' function.',
    EMPTY_TABLE_IN_ADDITIONAL_FIELDS: 'Validation error.\'tableName\' field cannot be empty in additionalFields record at index %s1. Specify a non-empty value instead.',
    EMPTY_FIELDS_IN_ADDITIONAL_FIELDS: 'Validation error.\'data\' object cannot be empty in additionalFields record at index %s1. Specify a non-empty value instead.',
    ...
    MISSING_TABLE_IN_COLLECT: 'Validation error.\'tableName\' key not found for collect element. Specify a valid value for \'tableName\' key.',
    EMPTY_TABLE_IN_COLLECT: 'Validation error.\'tableName\' cannot be empty for collect element. Specify a non-empty value for \'tableName\'.',
    EMPTY_SKYFLOW_ID_IN_ADDITIONAL_FIELDS: 'Validation error.\'skyflowId\' cannot be empty in additionalFields record at index %s1. Specify a non-empty value for \'skyflowId\'.',
    ...
    INVALID_TABLE_IN_COLLECT: 'Validation error. Invalid type for \'tableName\' key value for collect element. Specify a value of type string instead.',
    ...
    INVALID_UPSERT_OPTION_OBJECT_TYPE:
      'Validation error. Invalid value in upsert array at index %s1 in insert options. Specify objects with \'tableName\' and \'uniqueColumns\' keys instead.',
    MISSING_TABLE_IN_UPSERT_OPTION:
      'Validation error. Missing \'tableName\' key in upsert array at index %s1. Provide a valid \'tableName\' key.',
    ...
    INVALID_TABLE_IN_UPSERT_OPTION:
      'Validation error. Invalid \'tableName\' key in upsert array at index %s1. Specify a value of type string instead.',
