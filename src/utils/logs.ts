...
const logs = {
  infoLogs: {
    ...
    VALIDATE_3DS_INPUT: '%s1 - Validating 3DS input.',
    ...
    THREE_DS_TRIGGERED: '%s1 - 3DS method triggered.',
    INVOKE_3DS_RESOLVED: '%s1 - Invoke 3DS promise resolved successfully.',
  ...
  errorLogs: {
    ...
    INVOKE_3DS_REJECTED: 'Please check the Request payload - Invoke 3DS promise rejected successfully.',
    ELEMENTS_NOT_MOUNTED_INVOKE_3DS: 'Interface: invoke3DS - element for %s1 is not mounted ',
    INVALID_OBJECT_IN_3DS: 'Interface: client 3DS - Invalid Object. 3DS object is invalid.',
    MISSING_CARD_DETAILS_IN_3DS: 'Interface: client 3DS - Missing card details. 3DS object is invalid.',
    MISSING_CONFIG_DETAILS_IN_3DS: 'Interface: client 3DS - Missing config details with aqcuirer and merchant details. 3DS object is invalid.',
    MISSING_AMOUNT_DETAILS_IN_3DS: 'Interface: client 3DS - Missing amount details. 3DS object is invalid.',
    INVALID_CARD_NUMBER_IN_3DS: 'Interface: client 3DS - Invalid card number. 3DS object is invalid.',
    MISSING_CARD_NUMBER_IN_3DS: 'Interface: client 3DS - Missing card number. 3DS object is invalid.',
    INVALID_CARDHOLDER_NAME_IN_3DS: 'Interface: client 3DS - Invalid cardholder name. 3DS object is invalid.',
    MISSING_CARDHOLDER_NAME_IN_3DS: 'Interface: client 3DS - Missing cardholder name. 3DS object is invalid.',
    INVALID_CARD_EXPIRY_IN_3DS: 'Interface: client 3DS - Invalid card expiry. 3DS object is invalid.',
    MISSING_CARD_EXPIRY_IN_3DS: 'Interface: client 3DS - Missing card expiry. 3DS object is invalid.',
    INVALID_SCHEME_ID_IN_3DS: 'Interface: client 3DS - Invalid scheme ID. 3DS object is invalid.',
    MISSING_SCHEME_ID_IN_3DS: 'Interface: client 3DS - Missing scheme ID. 3DS object is invalid.',
    INVALID_ACQUIRER_MERCHANT_ID_IN_3DS: 'Interface: client 3DS - Invalid Acquirer merchant ID. 3DS object is invalid.',
    MISSING_ACQUIRER_MERCHANT_ID_IN_3DS: 'Interface: client 3DS - Missing Acquirer merchant ID. 3DS object is invalid.',
    INVALID_ACQUIRER_BIN_IN_3DS: 'Interface: client 3DS - Invalid Acquirer BIN. 3DS object is invalid.',
    MISSING_ACQUIRER_BIN_IN_3DS: 'Interface: client 3DS - Missing Acquirer BIN. 3DS object is invalid.',
    INVALID_ACQUIRER_ID_IN_3DS: 'Interface: client 3DS - Invalid Acquirer ID. 3DS object is invalid.',
    INVALID_MERCHANT_MCC_IN_3DS: 'Interface: client 3DS - Invalid Merchant mcc. 3DS object is invalid.',
    MISSING_MERCHANT_MCC_IN_3DS: 'Interface: client 3DS - Missing Merchant mcc. 3DS object is invalid.',
    INVALID_MERCHANT_NAME_IN_3DS: 'Interface: client 3DS - Invalid Merchant NAME. 3DS object is invalid.',
    MISSING_MERCHANT_NAME_IN_3DS: 'Interface: client 3DS - Missing Merchant NAME. 3DS object is invalid.',
    INVALID_MERCHANT_URL_IN_3DS: 'Interface: client 3DS - Invalid Merchant URL. 3DS object is invalid.',
    MISSING_MERCHANT_URL_IN_3DS: 'Interface: client 3DS - Missing Merchant URL. 3DS object is invalid.',
    INVALID_MERCHANT_COUNTRY_IN_3DS: 'Interface: client 3DS - Invalid Merchant country code. 3DS object is invalid.',
    MISSING_MERCHANT_COUNTRY_IN_3DS: 'Interface: client 3DS - Missing Merchant country code. 3DS object is invalid.',
    INVALID_REQUESTOR_NAME_IN_3DS: 'Interface: client 3DS - Invalid Requestor name. 3DS object is invalid.',
    ...
    INVALID_REQUESTOR_TRANS_ID_IN_3DS: 'Interface: client 3DS - Invalid Requestor server transaction ID. 3DS object is invalid.',
    INVALID_PROTOCOL_VERSION_IN_3DS: 'Interface: client 3DS - Invalid Protocol version. 3DS object is invalid.',
    INVALID_AMOUNT_IN_3DS: 'Interface: client 3DS - Invalid Amount. 3DS object is invalid.',
    MISSING_AMOUNT_IN_3DS: 'Interface: client 3DS - Missing Amount. 3DS object is invalid.',
    INVALID_PURCHASE_CURRENCY_IN_3DS: 'Interface: client 3DS - Invalid Purchase currency. 3DS object is invalid.',
    MISSING_PURCHASE_CURRENCY_IN_3DS: 'Interface: client 3DS - Missing Purchase currency. 3DS object is invalid.',
    INVALID_PURCHASE_EXPONENT_IN_3DS: 'Interface: client 3DS - Invalid Purchase exponent. 3DS object is invalid.',
    MISSING_PURCHASE_EXPONENT_IN_3DS: 'Interface: client 3DS - Missing Purchase exponent. 3DS object is invalid.',
