const logs = {
  infoLogs: {
    ...
    VALIDATE_SOAP_CONNECTION_CONFIG: '%s1 - Validating soap connection config.',
    ...
    INVOKE_SOAP_CONNECTION_TRIGGERED: '%s1 - Invoke soap connection triggered.',
    ...
    SEND_SOAP_INVOKE_CONNECTION_RESOLVED: '%s1 - Invoke soap connection request resolved.',
  ...
  errorLogs: {
    ...
    SEND_INVOKE_SOAP_CONNECTION_REJECTED: 'Interface: client invokeSoapConnection - invokeSoapConnection request rejected.',
    ...
    MISSING_SOAP_CONNECTION_CONFIG: 'Interface: invokeSoapConnection - config object is required',
    MISSING_SOAP_CONNECTION_URL: 'Interface: invokeSoapConnection - "connectionURL" key is required',
    EMPTY_SOAP_CONNECTION_URL: 'Interface: invokeSoapConnection - connectionURL cannot be empty',
    INVALID_SOAP_CONNECTION_URL_TYPE: 'Interface: invokeSoapConnection - connectionURL is invalid. connectionURL of type string is required',
    INVALID_SOAP_CONNECTION_URL: 'Interface: invokeSoapConnection - connectionURL is invalid',
    INVALID_ELEMENT_ID_IN_SOAP_REQUEST_XML: 'Interface: invokeSoapConnection - Element not found. Invalid elementID %s1 in requestXml',
    INVALID_ELEMENT_ID_IN_SOAP_RESPONSE_XML: 'Interface: invokeSoapConnection - Element not found. Invalid elementID %s1 in responseXml',
    DUPLICATE_ELEMENT_IN_SOAP_RESPONSE_XML: 'Interface: invokeSoapConnection - Invalid responseXML. Duplicate elementID found in responseXML',
    ELEMENT_NOT_MOUNTED_IN_SOAP_RESPONSE_XML: 'Interface: invokeSoapConnection - Element %s1 not mounted in responseXml',
    ELEMENT_NOT_MOUNTED_IN_SOAP_REQUEST_XML: 'Interface: invokeSoapConnection - Element %s1 not mounted in requestXml',
    MISSING_SOAP_REQUEST_XML: 'Interface: invokeSoapConnection - "requestXML" key is required',
    EMPTY_SOAP_REQUEST_XML: 'Interface: invokeSoapConnection - requestXML is required',
    INVALID_SOAP_REQUEST_XML_TYPE: 'Interface: invokeSoapConnection - Invalid requestXML. requestXML of type string is required',
    INVALID_SOAP_RESPONSE_XML_TYPE: 'Interface: invokeSoapConnection - Invalid responseXML. responseXML of type string is required',
    INVALID_HTTP_HEADERS_TYPE: 'Interface: invokeSoapConnection - Invalid httpHeaders',
    INVALID_SOAP_REQUEST_XML: 'Interface: invokeSoapConnection - Invalid requestXML, %s1',
  ...
  warnLogs: {
    ...
    DEPRECATE_INVOKE_CONNECTION: 'This method is deprecated and support for it will be removed soon. Please use any of the server-side SDK to invoke a connection',
  },
};
