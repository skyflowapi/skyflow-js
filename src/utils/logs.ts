...
const logs = {
  ...
  errorLogs: {
    ...
    MISSING_TABLE_IN_COLLECT: `${sdkLanguageAndVersion} Validation error.'table' key not found in Element. Specify a valid value for 'table' key.`,
    EMPTY_TABLE_IN_COLLECT: `${sdkLanguageAndVersion} Validation error.'table' cannot be empty in Element. Specify a non-empty value for 'table'.`,
    ...
    INVALID_TABLE_IN_COLLECT: `${sdkLanguageAndVersion} Validation error. Invalid type for 'table' key value in records at index %s1. Specify a value of type string instead.`,
    INVALID_SKYFLOWID_IN_COLLECT: `${sdkLanguageAndVersion} Validation error. Invalid type for 'skyflowID' key value in records. Specify a value of type string instead.`,
    MISSING_COLUMN_IN_COLLECT: `${sdkLanguageAndVersion} Validation error. 'column' key not found in records at index %s3. Specify a valid column.`,
    MISSING_SKYFLOWID_IN_COLLECT: `${sdkLanguageAndVersion} Validation error. 'skyflow_id' key not found in records at index %s3. Specify a valid skyflowID.`,
    EMPTY_COLUMN_IN_COLLECT: `${sdkLanguageAndVersion} Validation error. 'column' key cannot be empty in records at index %s3. Specify a non-empty value instead.`,
    INVALID_COLUMN_IN_COLLECT: `${sdkLanguageAndVersion} Validation error. Invalid type for 'column' key in records at index %s3. Specify a value of type string instead.`,
    ...
    DUPLICATE_ELEMENT_ADDITIONAL_FIELDS: `${sdkLanguageAndVersion} Mount failed. '%s3' appeared in record index '%s4' in the additional fields. Make sure each column in a record is unique.`,
    ...
    MISSING_TABLE_IN_UPSERT_OPTION:
      `${sdkLanguageAndVersion} Validation error. Missing 'table' key in upsert array at index %s3. Provide a valid 'table' key. %s4`,
    ...
    EMPTY_COLLECT_CUSTOM_FORMAT: `${sdkLanguageAndVersion} Mount failed. '%s3' can not be an empty object. Specify a valid object.`,
