const logs = {
  ...
  errorLogs: {
    ...
    MISSING_REGEX_IN_REGEX_MATCH_RULE: 'Missing regex in ValidationRule params at index %s1',
    INVALID_REGEX_IN_REGEX_MATCH_RULE: 'Invalid regex in ValidationRule params at index %s1',
