...
const logs = {
  infoLogs: {
    ...
    INSIDE_FRAME_ELEMENTS_CONSTRUCTOR: '%s1 - Inside FrameElements constructor',
    ...
    COLLECT_ELEMENT_START: '%s1 - %s2, Collect Element start',
    ...
    IFRAMEFORM_CONSTRUCTOR_FRAME_READY_LISTENER: '%s1 - In IFrameForm constructor, Adding listener for FRAME_READY event',
    IFRAMEFORM_CONSTRUCTOR_TOKENIZATION_LISTENER: '%s1 - In IFrameForm constructor, Adding listener for TOKENIZATION_REQUEST event',
  ...
  errorLogs: {
    ...
    RECORDS_KEY_NOT_FOUND_IN_ADDITIONAL_FIELDS: 'Validation error.records key not found in additionalFields. Specify a records key in additionalFields.',
    ...
    INVALID_FIELDS_IN_ADDITIONAL_FIELDS: 'Validation error.invalid \'fields\' key value in additionalFields record at index %s1. Specify a value of type array for \'fields\' key.',
    ...
    EMPTY_SKYFLOW_ID_IN_ADDITIONAL_FIELDS: 'Validation error.\'id\' cannot be empty in additionalFields record at index %s1. Specify a non-empty value for \'id\'.',
    ...
    INVALID_IFRAME: 'Error occurred while creating an iframe',
    ...
    INVALID_FIELD_SHOW_3DS_CHALLENGE: 'Invalid field \'%s1\'. Cannot initiate 3DS Challenge. Verify \'%s1\'',
  ...
  warnLogs: {
    ...
    UNABLE_TO_SET_VALUE_IN_PROD_ENV: '%s1 setValue() cannot invoked while in PROD env. It is Not Recommended',
    UNABLE_TO_CLEAR_VALUE_IN_PROD_ENV: '%s1 clearValue() cannot invoked while in PROD env. It is Not Recommended',
    COLLECT_ALT_TEXT_DEPRECATED: 'altText is DEPRECATED, passing altText will not have any effect',
    GET_BY_ID_DEPRECATED: 'getById is deprecated, use new get method',
    INPUT_FORMATTING_NOT_SUPPORTED: 'format or translation are not supported on %s1 element type.',
